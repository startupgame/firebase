...
import { getRedirectUrl, getSupabaseAuthOptions } from '../../lib/supabase/supabaseConfig';
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Get the auth options with the appropriate redirect URL for the current environment
